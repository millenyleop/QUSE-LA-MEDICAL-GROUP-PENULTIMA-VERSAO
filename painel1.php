...
<body>
    <div class="container">
        <h1>Bem-vindo à sua página de Médico</h1>
        <p>Aqui você pode ver consultas marcadas.</p>
        <a href="prontuarios.php" class="button" onclick="verconsultas()">Ver consultas agendadas</a>
